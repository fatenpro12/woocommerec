                                    ...
                                    <form method="Post" action="" class="info">
                                        ...
                                        <div class="row">
                                            ...
                                            <label for="nameAr" class="bmd-label-floating">{{ __('admin.products.title.ar') }}</label>
                                                <input id="nameAr" type="text" class="form-control" name="title.ar" value="{{ old('title.ar') }}" required autocomplete="title" autofocus>
                                                </div>
                                                    @error('title.ar')
                                            ...
                                            <div class="col-md-6" style="text-align: start!important;">
                                                <div class="form-group">
                                                    ...
                                                    <input id="titleEn" type="text" class="form-control" name="title.en" value="{{ old('title.en') }}" required autocomplete="title" autofocus>
                                                    @error('title.en')
                                                    <span class="danger">{{$message}}</span>
                                                    @enderror
                                                </div>
                                        ...
                                        <div class=" row">
                                            ...
                                            <div class="col-md-6" style="text-align: start!important;">
                                                <div class="form-group">
                                                    ...
                                                    <textarea id="descriptionen" class="form-control" name="description.en"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div style="border: 1px solid lightgray;padding: 1em;border-radius: 1em;margin-bottom: 1em">
                                                    <div class=" row">
                                                        <div class="col-md-6 form-group" style="text-align: start!important;">
                                                            ...
                                                            <input type="text" name="key[]" required value="" class="form-control house" id="exampleInputName1">
                                                        </div>
                                                        <div class="col-md-6 form-group" style="text-align: start!important;">
